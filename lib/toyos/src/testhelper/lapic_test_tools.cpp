...
void lapic_test_tools::write_divide_conf(uint32_t conf)
{
    uint32_t config;
    switch (conf) {
    case 2: config = 0b0000; break;
    case 4: config = 0b0001; break;
    case 8: config = 0b0010; break;
    case 16: config = 0b0011; break;
    case 32: config = 0b1000; break;
    case 64: config = 0b1001; break;
    case 128: config = 0b1010; break;
    default: config = 0b1011;
    }
