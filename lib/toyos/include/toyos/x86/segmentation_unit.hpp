...
public:
    ...
    segmentation_unit(const segment_descriptor& s, x86::cpu_mode mode) : segment_(s), mode_(mode) {}
    ...
    std::optional<uintptr_t> translate_logical_address(uintptr_t offset, x86::memory_access_type_t, size_t)
    {
        ...
        case x86::cpu_mode::PM64:
            return (segment_.seg == x86::segment_register::FS or segment_.seg == x86::segment_register::GS)
                       ? segment_.base + offset
                       : offset;
        default: return segment_.base + offset;
        };
    }
