...
struct multiboot_info
{
    ...
    bool has_cmdline() const { return flags & uint32_t(flag::CMDLINE); } ///< Returns true iff cmdline is valid.
...
struct multiboot_module
{
    ...
    bool __UBSAN_NO_UNSIGNED_OVERFLOW__ is_valid() const { return magic == MAGIC and (magic + flags + checksum) == 0; }
    bool address_header_valid() const { return flags & (1u << 16); }
};
