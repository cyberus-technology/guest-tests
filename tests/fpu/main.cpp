...
static constexpr zmm_t DESTROY_VAL_512 {DESTROY_VAL, DESTROY_VAL, DESTROY_VAL, DESTROY_VAL,
                                        DESTROY_VAL, DESTROY_VAL, DESTROY_VAL, DESTROY_VAL};
...
static void print_cpuid(uint32_t leaf, uint32_t subleaf)
{
    ...
    info("{#08x} {#08x}: eax={#08x} ebx={#08x} ecx={#08x} edx={#08x}", leaf, subleaf, res.eax, res.ebx, res.ecx,
         res.edx);
}
