...
namespace std  // purposefully not using versioning namespace
{
   ...
   const char* logic_error::what() const _NOEXCEPT
   {
      return __imp_.c_str();
   }
   ...
   runtime_error::runtime_error(const runtime_error& le) _NOEXCEPT : __imp_(le.__imp_)
   {}

   runtime_error& runtime_error::operator=(const runtime_error& le) _NOEXCEPT
   {
      __imp_ = le.__imp_;
      return *this;
   }
   ...
   const char* runtime_error::what() const _NOEXCEPT
   {
      return __imp_.c_str();
   }
