...
TEST_CASE(fixed_mtrrs_valid)
{
   const std::initializer_list<msr> msrs_mtrr{
      msr::MTRR_FIX_64K_00000,
      msr::MTRR_FIX_16K_80000,
      msr::MTRR_FIX_16K_A0000,
      msr::MTRR_FIX_4K_C0000,
      msr::MTRR_FIX_4K_C8000,
      msr::MTRR_FIX_4K_D0000,
      msr::MTRR_FIX_4K_D8000,
      msr::MTRR_FIX_4K_E0000,
      msr::MTRR_FIX_4K_E8000,
      msr::MTRR_FIX_4K_F0000,
